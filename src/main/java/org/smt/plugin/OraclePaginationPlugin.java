...
public class OraclePaginationPlugin extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        pageStart.addElement(new TextElement("SELECT * FROM (SELECT T.*, ROWNUM R FROM ( "));
        ...
        pageEnd.addElement(new TextElement("<![CDATA[ ) T WHERE ROWNUM<=#{limitEnd} ) WHERE R>#{limitStart} ]]>"));
